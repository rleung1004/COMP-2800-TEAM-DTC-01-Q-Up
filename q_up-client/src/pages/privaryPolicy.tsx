        ...
        <>
            ...
            <main>
                ...
                <section>
                    ...
                    <ul>
                        <li><span>Affiliate</span> means an entity that controls, is controlled by or is under common
                        ...
                        <li><span>Terms and Conditions</span> (also referred as "Terms") mean these Terms and Conditions
                        ...
                        <li><span>Third-party Social Media Service</span> means any services or content (including data,
                        ...
                        <li><span>Website</span> refers to Q-UP, accessible from https://www.q-up.ca</li>
                        <li><span>You</span> means the individual accessing or using the Service, or the company, or
                            other legal entity on behalf of which such individual is accessing or using the Service, as
                            applicable.
                        </li>
                        <li><span>Account</span> means a unique account created for You to access our Service or parts
                            of our Service.
                        </li>
                        <li><span>Country</span> refers to: British Columbia, Canada
                        </li>
                        ...
                        <li><span>Cookies</span> are small files that are placed on Your computer, mobile device or any
                    ...
                    <p>TWhile using Our Service, We may ask You to provide Us with certain personally identifiable
                    ...
                    <ul>
                        ...
                        <li>
                            <p><span>Cookies Policy / Notice Acceptance Cookies</span>
                            </p>
                    ...
                    <ul>
                        ...
                        <li><span>To manage Your Account:</span> to manage Your registration as a user of the Service.
                        ...
                        <li><span>For the performance of a contract:</span> the development, compliance and undertaking
                            of the purchase contract for the products, items or services You have purchased or of any
                        ...
                        <li><span>To provide You</span> with news, special offers and general information about other
                            goods, services and events which we offer that are similar to those that you have already
                            purchased or enquired about unless You have opted not to receive such information.
                        </li>
                        <li><span>To manage Your requests:</span> To attend and manage Your requests to Us.
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li><span>With Affiliates:</span> We may share Your information with Our affiliates, in which
                    ...
                    <ul>
                        <li>By visiting this page on our website: https://www.q-up.ca/contact/</li>
                    </ul>
                </section>
            </main>
            <Footer/>
