      ...
      .then((res) => {
        ...
        if (res.data.userType === "manager") {
          sessionStorage.setItem(
            "user",
            JSON.stringify({ token: res.data.generatedToken, type: "manager" })
          );
        } else if (res.data.userType === "customer") {
          sessionStorage.setItem(
            "user",
            JSON.stringify({ token: res.data.generatedToken, type: "customer" })
          );
        } else {
          sessionStorage.setItem(
            "user",
            JSON.stringify({ token: res.data.generatedToken, type: "employee" })
          );
        }
