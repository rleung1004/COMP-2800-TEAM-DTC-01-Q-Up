        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              "Us" or "Our" in this Agreement) refers to Q-UP.
            </li>
            <li>
            ...
            <li>
              <span>Third-party Social Media Service</span> means any services
          ...
          <ul>
            <li>
              By visiting this page on our website: https://www.q-up.ca/contact/
            </li>
          </ul>
        </section>
        {showEgg.value ? <EasterEgg exitEgg={exitEgg} /> : <> </>}
