                    ...
                    <Grid container item className='textContainer' xs={12} justify="center" alignItems="center">
                        ...
                        <Grid item xs={8}>
                            <ol className="orderedList">
                                ...
                                <li><Typography variant="body2" align="left">3 - Get your ticket number and your code
                                    city</Typography></li>
                                <li><Typography variant="body2" align="left">4 - Look for your ticket number in the
                                    queue display</Typography></li>
                                <li><Typography variant="body2" align="left">5 - When your turn comes, state your code
                                    city to the queue keeper</Typography></li>
                            </ol>
                        </Grid>
                    </Grid>
                </Grid>
