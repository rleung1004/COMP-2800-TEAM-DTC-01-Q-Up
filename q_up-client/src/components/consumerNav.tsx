...
/**
 * Render a hamburger menu with navigation oriented for consumer pages.
 */
        ...
        <List>
          <ListItem button key={"Dashboard"}>
            <Link className={classes.nodecor} to="/consumerDashboard">
              <ListItemText className={classes.white} primary={"Dashboard"} />
            </Link>
          </ListItem>
          ...
          <ListItem button key={"profile"}>
            <Link className={classes.nodecor} to="/consumerProfile">
              <ListItemText className={classes.white} primary={"Profile"} />
            </Link>
          </ListItem>
